...
const Contact = () => {
    return (
        <section className="py-12  rounded-3xl container mx-auto bg-gray-100 dark:text-gray-900 lg:mt-8">
	<div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
		...
		<form novalidate="" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
			...
			<label className="block">
				...
				<textarea rows="3" className="block w-full rounded-md focus:ring focus:ring-opacity-75 focus:dark:ring-violet-600 bg-gray-300"></textarea>
			</label>
